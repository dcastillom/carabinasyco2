        ...
        function HandleChanges(id)
        {
            ...
            if (ext){
                ...
                fileName.style.background = 'url(../modules/blocknews/i/input/icons.png) no-repeat 0 -'+pos+'px';
        ...
        function wrap(element)
        {
            ...
            fileName.style.background = 'url(../modules/blocknews/i/input/icons.png)';
        ...
        function delete_img(item_id){
        	...
        	$.post('../modules/blocknews/ajax.php', {
        		action:'deleteimg',
        		item_id : item_id
        	}, 
        	function (data) {
