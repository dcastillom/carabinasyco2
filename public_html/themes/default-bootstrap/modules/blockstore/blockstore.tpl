...
<div id="stores_block_left" class="block">
	...
	<div class="block_content blockstore">
        ...
        <p class="store-description">
        	{l s='Si desea probar alguno de los productos puede visitar nuestra tienda, en Carabinas y CO2 - Ferretería Nistal estaremos encantados de atenderle.' mod='blockstore'}
        </p>
		<div>
			<a 
